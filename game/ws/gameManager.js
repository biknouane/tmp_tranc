...
function endGame(matchId) {
  ...
  prisma.match.create({
    data: {
      id: matchId,
      player1: gameData.match.players[0],
      player2: gameData.match.players[1],
      score1: gameData.gameState.scores[gameData.match.players[0]],
      score2: gameData.gameState.scores[gameData.match.players[1]],
      winner: getWinner(gameData.gameState.scores)
    }
  }).then(() => {
    console.log(`Match ${matchId} recorded in the database.`);
  }).catch(err => {
